import GenereListmenu from "@/components/common/movie.UI/GenereListmenu";
...
import { movieCategoryList } from "../../constants/commonObj";
...
const Genere = () => {
  ...
  const filterRoutes = movieCategoryList
